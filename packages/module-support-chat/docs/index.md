...
(серьёзность, привязка дублей, рассылка обновлений), SSE-доставка изменений, вложения
(S3-хранилище core, картинки превью), плавающий виджет пользователя, портальная страница
«Мои обращения» (список обращений и история переписки), админ-приложение (список
обращений, переписка, ответ, статусы, инциденты), транскрипты на вендоренном `MessageScroller`.
