...
Что входит: API обращений и сообщений, SSE-доставка изменений, плавающий виджет
пользователя, админ-приложение (список обращений, переписка, ответ, закрытие),
транскрипты на вендоренном `MessageScroller`.

Что осознанно не входит: вложения, несколько тредов на пользователя, уведомления
по почте, разграничение прав поддержки. Под будущий AI-провайдер заложены роль `ai`
...
- Не проверено вживую: визуальный вид виджета и админ-приложения в браузере.
